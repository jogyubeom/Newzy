      ...
      <div className=" w-full h-[409px] bg-[#132956] relative flex items-center px-8">
        <div>
          ...
          <div className="absolute top-[263px] left-[249px] w-[100px] h-[100px]">
            ...
            ></svg>
            <img
              src="https://image-resource.creatie.ai/136922663561920/136922663561929/73c7ca5f71159d463c3aa99e7ed0d328.png"
              className="absolute top-[20px] left-[20px] w-[60px] h-[60px] object-cover"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col items-center ml-auto">
          ...
          <div className="w-[293px] h-[103px]">
            <div className="w-[293px] h-[73px] rounded-[45px] bg-[#3578FF]"></div>
