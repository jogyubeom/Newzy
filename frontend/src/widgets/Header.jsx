...
const Header = () => {
  ...
  <header className="h-[77px] flex justify-between items-center px-[28px]">
    <div className="flex-shrink-0 w-[985px] h-[72px] text-[#26262C] overflow-hidden whitespace-nowrap text-ellipsis font-[Open Sans] text-[36px] leading-[24px] font-semibold flex items-center justify-between text-justify">Newzy</div>
